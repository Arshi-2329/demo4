...
public void setCollege _name(String college_name){this.college_name=college_name;}
...
public void setStudent_name(String student name){this.student_name=student_name;}
public void setCourse_name(String course name){this.course_name=course_name;}
public void setAadhar_no(String aadhar no){this.aadhar_no=aadhar_no;}
...
ob.setAy_end(2026);
ob.setId(28556);
ob.setStudent_name("Arshiya");
ob.setCourse_name("cse");
ob.setAadhar_no("123453");
System.out.println(ob.getCollege_name());
System.out.println(ob.getCourse_address());
